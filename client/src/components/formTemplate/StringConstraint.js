    ...
    return (
        <div>
            ...
            onClose={_ => setAnchorEl(null)}>
                <MenuItem onClick={_=>handleDropDown('Minimum Length', 'number')}>Minimum Length</MenuItem>
                <MenuItem onClick={_=>handleDropDown('Maximum Length', 'number')}>Maximum Length</MenuItem>
            </Menu>
