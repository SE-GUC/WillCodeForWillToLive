...
export class RevieweritemA extends Component {
    ...
    return (
      <div style={this.getStyle()}>
        <p>
            ...
            <input type ="text" style={textfieldstyle} name="review_comment_by_reviewer" placeholder="اكتب رأيك..."
            value={this.state.review_comment_by_reviewer}
            onChange={this.textFOnChange}/> 
            <Button outline onClick={this.props.addreview.bind( this, _id, this.state.review_comment_by_reviewer)} color="primary" style = {btnStyle4}>عرض</Button>
            {' '}
