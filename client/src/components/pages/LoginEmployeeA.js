...
class LoginEmployeeA extends React.Component{
    state={
        username: '',
        password: '',
        showPassword: false
    ...
    login = () => {
      ...
      if(err){
        ...
        if(payload.type === 'admin'){
          document.location.href = '/adminprofileA'
        }
        if(payload.type === 'reviewer'){
          document.location.href = '/reviewerprofileA'
        }
        if(payload.type === 'lawyer'){
          document.location.href = '/lawyerprofileA'
        }
      }
      })
...
LoginEmployeeA.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(LoginEmployeeA);