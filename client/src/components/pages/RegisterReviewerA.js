...
import AlertDialogReviewerRegisterA from '../Dialog/AlertDialogReviewerRegisterA'
...
class RegisterReviewer extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <br/>
      <AlertDialogReviewerRegisterA  lawyeradmin={this.state}/>
